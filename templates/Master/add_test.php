<div class="content-header">
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-sm-6"><div class="col-sm-6"><?php echo $this->Html->link('Back', array('controller' => 'master', 'action'=>'saved-test-type'),array('class'=>'add_btn btn btn-secondary')); ?></div></div>
			<div class="col-sm-6">
							...
							<div class="card-header"><h3 class="card-title-new"><?php echo $title; ?></h3></div>
								...
								<div class="card-footer mt-4">
									<?php
										...
										echo $this->Html->link('Cancel', array('controller' => 'dashboard', 'action'=>'home'),array('class'=>'float-right btn btn-danger'));
									?>
								</div>
							</div>
						</div>
