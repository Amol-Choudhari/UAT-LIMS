...
<div class="content-header">
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-sm-6"><div class="col-sm-6"><?php echo $this->Html->link('Back', array('controller' => 'master', 'action'=>'saved_category'),array('class'=>'add_btn btn btn-secondary')); ?></div></div>
			<div class="col-sm-6">
