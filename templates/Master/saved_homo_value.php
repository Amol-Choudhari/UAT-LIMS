<div class="content-header">
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-sm-3"><label class="badge badge-success">Added Homogenization Values</label></div>
			<div class="col-sm-9">
				...
				<div class="col-md-12">
					<div class="card card-lims">
						<?php echo $this->Form->create(); ?>
							<div class="card-header"><h3 class="card-title-new">List of All Added Homogenization Values</h3></div>
										...
										<?php
											if(!empty($homoValueArray)){
												...
												<tr>
													...
													<td><?php echo $this->Html->link('', array('controller' => 'master', 'action'=>'fetch_homo_value', $each['m_sample_obs_type_code']),array('class'=>'glyphicon glyphicon-edit','title'=>'Edit')); ?>
														<?php if($homo_value=='Yes' || $homo_value=='No') {
																$val_type = 'yesno';
															} else {
																$val_type = 'single';
															}
