          		...
          		<div class="col-sm-6">
            		<ol class="breadcrumb float-sm-right">
						<li class="breadcrumb-item"><?php echo $this->Html->link('Dashboard', array('controller' => 'dashboard', 'action'=>'home'));?></li>
              			<li class="breadcrumb-item active">Code Files</li>
            		</ol>
				</div>
			</div>
		</div>
							...
							<div class="form-horizontal">
								<div class="card-body">
									<div class="row">
										...
										<div class="col-sm-3">
											<div class="form-group">
												<a  class="btn btn-block btn-outline-secondary" href="<?php echo $this->getRequest()->getAttribute('webroot');?>Master/saved-phy-appear/Sample_Obs">Homegenization</a>
											</div>
										</div>
										<div class="col-md-3">
											<div class="form-group">
							...
							<div class="form-horizontal">
								<div class="card-body">
									<div class="row">
										<div class="col-sm-3">
											<div class="form-group">
												<a class="btn btn-block btn-outline-secondary" href="<?php echo $this->getRequest()->getAttribute('webroot');?>Master/saved-assign-homo">Assign Homogenization to Commodity</a>
											</div>
										</div>
										<div class="col-sm-3">
											<div class="form-group">
