<?php 
	...
	echo $this->Html->Script('input_validation'); 
	echo $this->Html->css('master/phy_appear'); 
	...
	$masterHomeName = explode("-", $phyAppear['breadcrumb_on_list_menu'])[0];
?>
...
<div class="content-header">
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-sm-3">
				<a href="../saved-phy-appear/<?php echo $phyAppear['action']; ?>" class="btn btn-secondary">Back</a>
			</div>
			<div class="col-sm-9">
				<ol class="breadcrumb float-sm-right">
					<li class="breadcrumb-item"><?php echo $this->Html->link('Dashboard', array('controller' => 'dashboard', 'action'=>'home')); ?></li>
					<li class="breadcrumb-item"><?php echo $this->Html->link(ucfirst($masterHomeName). " Files", array('controller' => 'master', 'action'=>$phyAppear['breadcrumb_on_list_menu'])); ?></li>
				</ol>
			</div>
		</div>
	</div>
