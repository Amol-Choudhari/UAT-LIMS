								...
								<div class="card-body">
									<div class="row pb-2">
										...
										<div class="col-md-12">
											<div class="row">
												<div class="col-md-3">
													<label class="col-form-label">Sample Code <span class="required-star">*</span></label>
													...
													<span id="error_stage_sample_code" class="error invalid-feedback"></span>
												</div>
												<div class="col-md-3">
													<label class="col-form-label">Category <span class="required-star">*</span></label>
												...
												<div class="col-md-3">
													<label class="col-form-label">Commodity <span class="required-star">*</span></label>
												...
												<div class="col-md-3">
													<label class="col-form-label">Sample Type <span class="required-star">*</span></label>
										...
										<div class="col-md-12 mt-3">
											<div class="row">
												<div class="col-md-3">
													<label class="col-form-label">User Type <span class="required-star">*</span></label>
													...
													<span id="error_user_type" class="error invalid-feedback"></span>
												</div>
												<div class="col-md-3">
													<label class="col-form-label">User Name <span class="required-star">*</span></label>
													...
													<span id="error_alloc_to_user_code" class="error invalid-feedback"></span>
												</div>
												<div class="col-md-2">
													<label class="col-form-label">Quantity <span class="required-star">*</span></label>
													...
													<span id="error_sample_qnt" class="error invalid-feedback"></span>
												</div>
												<div class="col-md-2">
													<label class="col-form-label">Unit <span class="required-star">*</span></label>
													...
													<span id="error_sample_unit" class="error invalid-feedback"></span>
												</div>
												<div class="col-md-2">
													<label class="col-form-label">Test <span class="required-star">*</span></label>
													<div class="colmd-12">
										...
										<div class="col-md-12 mt-3">
											<div class="row">
												<div class="col-md-3">
													<label class="col-form-label">Expected Completion <span class="required-star">*</span></label>
													...
													<span id="error_expect_complt" class="error invalid-feedback"></span>
												</div>
											</div>
										</div>
									</div>
							...
							<div class="card-footer">
								<div class="col-md-12">
									<div class="col-md-1 float-left">
										<?php echo $this->Form->submit('Allocate', array('name'=>'save', 'id'=>'save', 'label'=>false,'class'=>'btn btn-success')); ?>
									</div>
									<div class="col-md-1 float-right">
										<a href="../SampleAllocate/available_to_allocate" class="btn btn-danger">Cancel</a>
									</div>
								</div>
							</div>
						</div>
...
<?php 
	echo $this->Html->Script('sample_forward_form');
	echo $this->Html->Script('sample_allocate_form');
	echo $this->Html->Script('sampleAllocate/sample-allocate'); 
?>
