...
<div class="container site-page">
   ...
   <div class="row">
    <div class="col-lg-12 mx-auto text-center">
      ...
      <p class="fontSize26"><b>Forward The Chemist To RO As Training Completed</b></p>
    <?php }else{ ?>
    ...
    <div class="card-body">
      <div class="row">
        <div class="col-md-12 row">
          <div class="col-md-2">
            <label for="field3"><span>RAL First Name <span class="cRed">*</span></span></label>
          </div>
          <div class="col-md-4">
        ...
        <div class="col-md-12 row">
          ...
          <div class="col-md-4">
            ...
            <div class="err_cv"></div>
                    ...
                    <label for="field3"><span>Ro Offices <span class="cRed">*</span></span></label>
                    </div>
                    <div class="col-md-4">
                    ...
                    <?php }else{ ?>
                    <label for="field3"><span>Reshedule From Date<span class="cRed">*</span></span></label>
                    </div>
                    <div class="col-md-4">
                    ...
                    <?php }else{ ?>
                      <div class="col-md-2">
                       <label for="field3"><span>Reshedule To Date<span class="cRed">*</span></span></label>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-12 row">
                    <div class="col-md-3">
                    <label for="field3"><span>Training has been completed <span class="cRed">*</span></span></label> 
                    </div>
