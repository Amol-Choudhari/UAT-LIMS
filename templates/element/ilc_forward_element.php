  ...
  <div class="container">
    <div class="row pb-3">
      <div class="col-md-12">
        <div class="table-responsive">
          ...
          <table class="table table-bordered table-striped table-hover" id="serialno">
            <thead>
    ...
    <div class="row border-top border-dark">
      ...
      <div class="col-md-9 p-3">
        <strong class="text-primary">Note: Select Min. 2 Test Parameters To process ILC For This Sample </strong>
      </div> 
    </div>
    <div class="row">
      <div class="col-md-12 table-responsive">
            <strong>Selected Test Parameters</strong>
            <table class="table table-bordered table-striped table-hover" id="srno">
              <thead>
                <tr class="table-secondary">
                  <th class="text-center">Sr. No.</th>
