			...
			<div class="card-footer p-0">
				<ul class="nav flex-column">
					<li class="nav-item row pt-2">
						...
						<div class="col-sm-6"><?php echo $this->Form->control('payment_amount', array('type'=>'text', 'escape'=>false, 'value'=>$payment_amount, 'id'=>'payment_amount', 'label'=>false, 'placeholder'=>'Please Enter Payment Amount','class'=>'form-control')); ?></div>
					...
					<li class="nav-item row pt-2">
						...
						<div class="col-sm-6"><?php echo $this->Form->control('payment_transaction_id', array('type'=>'text', 'escape'=>false, 'value'=>$payment_transaction_id, 'id'=>'payment_transaction_id', 'label'=>false, 'placeholder'=>'Please Enter Transaction ID/Receipt NO','class'=>'form-control')); ?></div>
					...
					<li class="nav-item row pt-2">
						...
						<div class="col-sm-6"><?php echo $this->Form->control('pao_name', array('type'=>'text', 'escape'=>false, 'value'=>$pao_to_whom_payment, 'id'=>'pao_name', 'label'=>false, 'readonly'=>true,'class'=>'form-control')); ?></div>
						<div id="error_payment_amount"></div>
					</li>
					<li class="nav-item row pt-2">
						<label for="field3" class="col-md-5"><span class="col-form-label">Date of Transaction<span class="required-star">*</span></span></label>
						<div class="col-sm-6"><?php echo $this->Form->control('payment_trasaction_date', array('type'=>'text', 'escape'=>false, 'value'=>$payment_trasaction_date[0], 'id'=>'payment_trasaction_date', 'label'=>false, 'readonly'=>true, 'placeholder'=>'Please Enter Date of Transaction','class'=>'form-control')); ?></div>
					...
					<?php if(!empty($_SESSION['advancepayment']) && $_SESSION['advancepayment']=='yes') { ?>
						<li class="nav-item row pt-2">
							...
							<div class="col-sm-6"><?php echo $this->Form->control('payment_for', array('type'=>'select', 'escape'=>false, 'value'=>'1', 'options'=>array('1'=>'Advance Replica Payment'), 'id'=>'payment_for', 'label'=>false, 'readonly'=>true)); ?></div>
							<div id="error_payment_trasaction_date"></div>
						</li>
					<?php } ?>
...
<div class="form-buttons">
	<?php 
		if (!(trim($status_flag)== 'S' || trim($status_flag) =='PV')) {
			if ($confirmBtnStatus =='show') { ?>
			<div class="col-md-1 float-left"><?php echo $this->Form->submit('Confirm', array('name'=>'confirm', 'id'=>'confirm', 'label'=>false,'class'=>'btn btn-success')); ?></div>
		<?php } ?>
	<?php } ?>

	<?php if($_SESSION['user_flag'] == 'CAL' || $_SESSION['user_flag'] =='RAL') { ?>
	...
	<?php 
		if (!trim($status_flag =='PV') || (trim($status_flag =='PV') && ($payment_confirmation_status == 'not_confirmed'))) { 
			echo $this->Form->submit('Save', array('name'=>'save', 'id'=>'submit_payment_detail', 'label'=>false,'class'=>'btn btn-success float-right'));
		} 
	?>
</div>
