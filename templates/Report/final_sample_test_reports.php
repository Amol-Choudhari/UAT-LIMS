                                        ...
                                        if (isset($final_reports)) {
                                            ...
                                            foreach ($final_reports as $res2) :
                                                ...
                                                <tr>
                                                    ...
                                                    <?php if(!empty($res2[0]['report_pdf'])){?>
														<td><a href="<?php echo $res2[0]['report_pdf']; ?>" target='_blank' class="btn btn-info">View</a></td>
													<?php }else { ?>
														<td><a href="<?php echo $this->request->getAttribute('webroot'); ?>FinalGrading/sample_test_report_code/<?php echo trim($res2[0]['stage_smpl_cd']) . '/' . $res2[0]['commodity_code']; ?>" target='_blank' class="btn btn-info">View</a></td>
													<?php } ?>
                                                </tr>
                                        <?php endforeach;
                                        } ?>
