						...
						<div class="card card-lims">
							...
							<div class="card-footer">
								<span id="finalise_id" class="fiz">
									<input type='button' name='Finalize' id='finalize' class="btn btn-primary float-left" disabled value='Finalize' title='This finalised button will be active once all test reading final'>
								</span>
								<span id="ral_id" class="fiz" >
									<input type='button' name='Send to RAL' id='ral' class="btn btn-success float-left" disabled value='Approve Result'>
								</span>
								<span id="cal_id" class="fiz" >
									<input type='button' name='Send to CAL' id='cal' class="btn btn-primary float-left" disabled value='Send to Inward'>
								</span>
								<span id="ho_id" class="fiz" >
									<input type='button' name='Send to HO' id='ho' class="btn btn-primary float-left" disabled value='Send to HO'>
								</span>
								<span id="closediv" class="pt-2">
									<a href="../ApproveReading/available_for_approve_reading" class="btn btn-danger float-right">Cancel</a>
								</span>
							</div>
						</div>
