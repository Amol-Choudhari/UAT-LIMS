							...
							<div class="form-horizontal mb-3">
								<div class="card-body">
									...
									<div class="row">
										...
										<div class="col-md-3">
											<label class="col-form-label">Commodity Name <span class="required-star">*</span></label>
										...
										<div class="col-md-3">
											<label class="col-form-label">Select Office <span class="required-star">*</span></label>
											<div class="colmd-12">
										...
										<div class="col-md-3 mt-3">
											<label class="col-form-label">Forward To <span class="required-star">*</span></label>
										...
										<div class="col-md-3 mt-3">
											<label id="dst_usr_lbl" class="col-form-label">User Name <span class="required-star">*</span></label>
