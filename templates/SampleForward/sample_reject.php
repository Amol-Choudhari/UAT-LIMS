					...
					<?php echo $this->Form->create(null, array('id'=>'frm_sample_reject','class'=>'form-group')); ?>
						<div class="card card-lims">
								...
								<div class="card-body">
									...
									<div class="row">
										...
										<div class="col-md-3" id="reject_box_field">
											<label class="col-form-label">Reason to Reject Sample <span class="required-star">*</span></label>
							...
							<div class="card-footer mt-2">
								<?php echo $this->Form->submit('Reject Sample', array('name'=>'sample_reject', 'id'=>'sample_reject', 'label'=>false,'class'=>'btn btn-success float-left')); ?>
