										...
										<table id="view_perform_sample" class="table table-bordered table-hover table-active"> 
											...
											<tbody>
												<?php $i=1; foreach($list_of_finalized_test as $each_record){ ?>
													...
													<!-- add new view calculation chemist report on 20-01-2023 By Shreeya -->
													<td>
														<a class='glyphicon glyphicon-eye-open' href='chemist_test_report_code/<?php echo trim($each_record['stage_smpl_cd']);?>/<?php echo trim($each_record['commodity_code']);?>' target='_blank' title="Chemist Report"></a> |
														<a class='glyphicon glyphicon-plus' href='calculate_chem_test_report_code/<?php echo trim($each_record['stage_smpl_cd']);?>/<?php echo trim($each_record['commodity_code']);?>' target='_blank' title="Chemist Calculation Report"></a>
													</td>
													</tr>							
												<?php $i++; } ?>
											</tbody>
