						...
						<?php echo $this->Form->create(); ?>
							<div class="card card-lims">
									...
									<div class="col-md-12 row">
										...
										<div class="col-md-2">
											<a href="#finalzscoremodal" target='_blank' data-toggle="modal" data-target="#finalzscoremodal" id="get_zscore" class="btn btn-outline-success" required>Finalize Z-score</a>
										</div>
									</div>
...
<!-- add new js for saving zscore with selected options 21-03-2023-->
<?php echo $this->Html->Script('finalGrading/ilc_save_zscore'); ?>
