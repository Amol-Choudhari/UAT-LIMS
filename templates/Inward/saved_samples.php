													...
													<?php if(!empty($sampleArray)){
														...
														foreach($sampleArray as $each){ ?>
															<tr>
																...
																<td><?php if (!empty($each['received_date'])) {
												...
												<?php
													if (!empty($sampleArray)) {
														...
														<tr>
															...
															<td>
																<!-- while testing sample register add trim fun also add else condition for status flag R  Date : 17-03-2023 By Shreeya-->
																<?php if(trim($each['acc_rej_flg'])=="A") { 
																		echo "Accepted";
																	} else if(trim($each['acc_rej_flg']) =="P") { 
																		echo "Pending";
																	}else if(trim($each['acc_rej_flg'])=="R") { 
																		echo "Rejected";
																	} 
																?>
															</td>
