 ...
 $("#input_parameter_text").on("blur","input[type='text']",function(e){
   ...
   if(para1 != 'undefined' && para2 != 'undefined')
   {
	...
	$("#input_parameter_text").on("blur","input[type='test']",function(e){
		...
		//var i= /^[a-zA-Z0-9]*$/.test($(this).val()); updated as below on 23-01-2023 by Akash
		var i= /^([a-zA-Z0-9 _-]+[\,\.]+)*[a-zA-Z0-9 _-]*$/.test($(this).val());
		if(i==false){
			$.alert('Value should be Alpha-numeric only');
		}
